...
python3 -m unittest tests.control_plane.test_project_archive tests.control_plane.test_skills_sync tests.control_plane.test_azure_model_catalog tests.control_plane.test_codex_native_env tests.control_plane.test_codex_provider
python3 -m unittest \
